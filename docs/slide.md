...
個人的にも、また現在案件でも Vuex を使っています。そこで思うのですが、Vuex、分かりづらくて面倒くさいです。さらに TypeScript で書くと輪をかけて分かりづらく面倒くさいです。

今日は Vuex の分かりづらく面倒くさい部分と、その改善案についての話をさせてもらいます。

「自分は React 派なので Vuex には興味がない」という方でも、今日の話が何かしら役に立つかもしれないので、とりあえず聞いていただけたらと思います。
...
* 画面からストアを利用する
<!--
画面から Vuex のストアを利用するための分かりづらく面倒くさいコーディングを見ていきます。
-->
* 画面からストアを利用する方法を改善する
<!--
画面から Vuex のストアを利用するための分かりづらく面倒くさいコーディングを改善します。
-->
...
<!--
分散していたユーザー情報が ストア（Vuex）に集約されました。これにより、ユーザー情報の取得、編集は必ずストアを経由することになります。
-->
...
ミューテーションはステートの<span style="color: red;">編集</span>をするための機能を提供します。
